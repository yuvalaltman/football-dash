...
radar_vars_info_txt = {
    ...
    "passes_completed_long_per90": "successful passes longer than 30 yards",
    "crosses_into_penalty_area_per90": "attempts of passing the ball into the opponent's box",
    ...
    "sca_per90": "offensive actions directly leading to a shot",
    "gca_per90": "offensive actions directly leading to a goal",
    "assisted_shots_per90": "passes that directly lead to a shot",
    "shots_total_per90": "shots at goal, excluding penalties",
    "xg_per90": html.A("expected goals", href="https://fbref.com/en/expected-goals-model-explained/", target="_blank"),
    "xa_per90": html.A("expected assists", href="https://fbref.com/en/expected-goals-model-explained/", target="_blank"),
